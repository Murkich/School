...
<@c.page>
    ...
    <div class="container mt-5" xmlns="http://www.w3.org/1999/html">
        ...
        <div  id = "cont" >
                    ...
                    <#if isAdmin>
                        <th>
                            <form action="/request/add" method="get">
                                <input type="submit" value="Создать курс" class="filter-button">
                                <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            </form>
                        </th>
                        <th>
                            <form action="/request/edit" method="get">
                                <input type="submit" value="Редактировать" class="filter-button">
                                <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            </form>
                        </th>
                        <th>
                            <form action="/request/delete" method="get">
                                <input type="submit" value="Удалить" class="filter-button">
                                <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                            </form>
                        </th>
                    </#if>
            ...
            <#if isUser>
                <form action="/request/order" method="get">
                    <input type="submit" value="Забронировать" class="filter-button">
                    <input type="hidden" name="_csrf" value="${_csrf.token}"/>
                </form>
            </#if>
